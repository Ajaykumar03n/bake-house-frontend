...
export const DisplayEmployees = () => {
    ...
    const handleRemoveEmployee = async () => {
        if (confirmRemove) {
            ...
            try {
                await axios.delete(`https://bake-house-backend.onrender.com/api/employee/delete-employee/${confirmRemove}`);
    ...
    const handleAddOrUpdateEmployee = async (e) => {
        ...
        try {
            ...
            if (editingEmployee) {
                ...
                await axios.put(`https://bake-house-backend.onrender.com/api/employee/update-employee/${editingEmployee._id}`, {
                    ...newEmployee,
                    imageUrl,
                });
                ...
                // Add new employee
                const res = await axios.post("https://bake-house-backend.onrender.com/api/employee/add-employee", {
                    ...newEmployee,
                    imageUrl,
                });
