...
import cake5 from '/cake2.jpg';
import cake1 from '/cake5.jpg';
...
export const HomeuserUser = () => {
    ...
    return (
        <>
            <UserNavbar />
            <div className='h-screen mt-20 bg-black bg-opacity-70 bg-blend-overlay bg-[url("/cake4.jpg")] bg-no-repeat bg-cover bg-center'>
                ...
                <div className='z-10 flex flex-col justify-center h-full gap-8 p-12 pt-24'>
                    ...
                    <p className='text-6xl text-white font-medium leading-relaxed'>
                        Explore Your <br />
                        <span className='text-green-500'>Taste Buds With </span> <br />
                        Our Cake
                    </p>
            ...
            <div className='bg-white py-24 px-8'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-600 mb-12 text-lg mt-8'>
                                Join thousands of happy customers who love our handcrafted cakes, pastries, and sweet treats.
                                Whether it's a birthday, wedding, or just because — let’s make your moments delicious!
                            </p>
                ...
                <div className='flex gap-8 max-w-6xl mx-auto'>
                    {[
                        { img: cake5, title: 'Cakes' },
                        { img: milkshake, title: 'MilkShakes' },
                        { img: icecream, title: 'Icecream' }
                    ].map(({ img, title }, i) => (
                        <div
                            key={i}
            ...
            <div className='bg-gray-100' id='contact'>
                <h1 className='text-center text-4xl font-semibold pt-24'>
                    Contact Me
                </h1>
                ...
                <div className='max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12'>
                    ...
                    <div>
                        ...
                        <p className='text-gray-400'>
                            At SweetCrumbs Bakery, we believe every celebration deserves a perfect cake.
                            What started as a small kitchen dream has grown into a beloved destination for
                            handcrafted cakes, cupcakes, cookies, and more — all made with love and the finest ingredients.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2'>
                            ...
                            <li><a href='/useremployees' className='hover:text-green-400 transition'>Products</a></li>
                            {token && (

                                <li><a href='/userorder' className='hover:text-green-400 transition'>Orders</a></li>
                            )}
                        </ul>
                    </div>
