...
export const Homeuser = () => {
    ...
    return (
        <>
            <Navbar />
            <div className='h-screen bg-black bg-opacity-60 bg-blend-overlay bg-[url("/cake4.jpg")] bg-no-repeat bg-cover bg-center'>
                ...
                <div className='max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12'>
                    ...
                    <div>
                        ...
                        <p className='text-gray-400'>
                            ...
                            handcrafted cakes, cupcakes, cookies, and more — all made with love and the finest ingredients.                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2'>
                            ...
                            <li><a href='/employees' className='hover:text-green-400 transition'>Product</a></li>
                            <li><a href='/users' className='hover:text-green-400 transition'>Users</a></li>
